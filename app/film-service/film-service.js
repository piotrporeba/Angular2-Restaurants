...
var Film = /** @class */ (function () {
    function Film(id, openingHours, averagePrice, address, title, county, location, type, score, about) {
        this.id = id;
...
var FilmService = /** @class */ (function () {
    ...
    FilmService.prototype.getFilmsBySelection = function (cou, loc, typ, sco) {
        this.films2 = [];
        var counter = 0;
        for (var i = 0; i < this.films.length; i++) {
            ...
            if (this.films[i].county == cou && (sco == null || typ == "" || loc == "")) {
